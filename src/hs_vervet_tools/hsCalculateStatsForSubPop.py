...
class CalculateStatsForSubPop(AbstractVervetMapper):
	...
	def saveVCF_ids(self,vcfid_ls):
		outFnameID='/media/Data/Akademisches_data/vervetpopgen/AfricaExtractedData/Meth40AllCont_VCFind_ls.tsv'
	...
	def run(self):
		...
		Fname="/media/Data/Akademisches_data/vervetpopgen/AfricaExtractedData/Method39ContigNames.tsv"
