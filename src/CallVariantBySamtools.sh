...
if test $# -lt 4
then
	echo "Usage: $0 refFastaFname interval outputVCF inputBAM1 inputBAM2 ..."
	echo
	echo "Note:"
	...
	echo
	echo "Example:"
	echo "	$0 120_480K_supercontigs.fasta Contig0:1-2000000 Contig0_1_2000000.vcf 1_vs_120.bam 2_vs_120.bam"
exit
fi
...
$samtoolsPath mpileup -I -S -D -q 20 -ug -r $interval -f $refFastaFname $bamFiles | $bcftoolsPath view -bvcg - > $outputVCF.bcf
